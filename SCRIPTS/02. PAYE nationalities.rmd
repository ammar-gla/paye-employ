...
-  By December 2022, EU nationals accounted for around `r pull_data_det(dt_day="2022-12-01",nat="eu",meas="counts")` employments (`r pull_data_det(dt_day="2022-12-01", nat="eu",meas="share",typ="%",geo="london",decimals=0)`%) while non-EU nationals accounted for `r pull_data_det(dt_day="2022-12-01",nat="non_eu",meas="counts")` employments (`r pull_data_det(dt_day="2022-12-01", nat="non_eu",meas="share",typ="%",geo="london",decimals=0)`%).
