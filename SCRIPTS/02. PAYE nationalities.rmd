...
This release is an update of our [previous analysis](https://data.london.gov.uk/download/gla-economics-covid-19-labour-market-analysis/df64d525-e65c-4dd6-a6e5-270919aeab7e/PAYE%20Employments%20by%20nationality.html) and now covers the period from July 2014 to December 2022. Over the first three years of this period, the number of employments held by EU workers in London rose from around 620,000 to around 830,000, the same as the number of employments held by non-EU workers.

Four years later, it was well below 800,000 again, while non-EU employments rocketed to above a million.

While most London industries have recovered to pre-pandemic levels of employments, some have seen a radical change in the composition of nationalities. Hospitality has lost 30% of employments held by EU workers but gained almost 40% held by non-EU workers.

The changes are less stark when considering the UK average as the rest of the UK historically had a far lower share of EU workers than London, at around `r pull_data_det(dt_day="2019-12-01",nat="eu",meas="share",typ="%",geo="uk",decimals=0)`% vs. `r pull_data_det(dt_day="2019-12-01",nat="eu",meas="share",typ="%",geo="london",decimals=0)`% in December 2019.
...
Following the post-lockdown decrease in payrolled employments overall, the number of employments held by non-EU*  workers rose steadily from January 2021 onwards while the number of EU employments stabilised. This period coincided with the end of free migration for EU citizens.
...
These differences are even more pronounced within certain industries, particularly within Hospitality and Construction:
...
Hospitality saw the steepest falls during the pandemic, as it was particularly vulnerable to migration controls due to its large share of EU workers. The increase in non-EU workers in 2022 has nevertheless lifted the overall level of employments above pre-pandemic levels.
...
* Transport & storage recorded the largest decrease in payrolled employments at `r pull_data_det(var="p_change_feb20",nat="overall",meas="counts",typ="%",abs=TRUE,sec="Transport & storage")`%. This decrease was largely unrelated to migration trends as most employments were were held by UK workers.
...
The table below shows the number of employments by nationality in London in December 2022. As the data is not seasonally adjusted, we compare with levels in December 2019 to avoid potential biases related to seasonal employment. The comparison is also useful as December 2019 also saw EU and non-EU employments at nearly the same level.
...
This release concerns the movement of workers from abroad to the UK. The following dates are relevant in this context as they affected migration rights, which includes the process of the UK leaving the EU.
